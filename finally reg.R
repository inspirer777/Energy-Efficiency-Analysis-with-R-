...
data<- read_excel("C:/Users/HHP/Desktop/data.xlsx")
View(data)
attach(data)
names(data)
summary(data)
...
# regsubs
X <- cbind(vx1,vx2,vx3,vx4,vx5,vx6,vx7)
b<-regsubsets(as.matrix(X),vy)
summary(b)
rs <- summary(b)
par(mfrow=c(1,2))
...
lmd1 <- lm(vy~bx5)
lmd2 <- lm(vy~bx5+vx7)
lmd3 <- lm(vy~bx3+vx5+bx7)
lmd4 <- lm(vy~vx3+vx4+vx5+vx7)
lmd5 <- lm(vy~vx2+vx3+vx4+vx5+vx7)
lmd6 <- lm(vy~vx2+vx3+vx5+vx6+vx7)
lmd7 <- lm(vy~vx1+vx2+vx3+vx5+vx6+vx7)
